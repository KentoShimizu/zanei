...
Stop the recorder before uninstalling it:
...
Remove the Accessibility and Input Monitoring grants in **System Settings → Privacy & Security**. If the `Zanei` entry is no longer listed there, run:
