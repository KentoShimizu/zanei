...
- Chrome text-content bodies are confirmed one poll (about 1 second) after input. Text typed within about a second before switching that Chrome window to an excluded or Incognito tab is omitted.
