...
- **Website scopes.** Website rules apply to Chrome and, in the unreleased development version, Safari. Safari URL filtering does not imply private-window detection. Other browsers are controlled by app scope.
