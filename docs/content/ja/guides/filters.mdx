...
filter reload で Chrome を対象に加えると、recorder の再起動なしで Chrome tracking が始まり、再び除外すると停止します。macOS の Automation prompt は Chrome を初めて対象に加え、その権限が初めて必要になった時点で表示されます。
