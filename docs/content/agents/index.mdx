...
| **[MCP server](/reference/mcp)** | `zanei mcp`, a stdio JSON-RPC server exposing read-only tools | Shell-less clients (Claude Desktop, ChatGPT connectors), for which MCP is the only path. Terminal agents can use it too |
