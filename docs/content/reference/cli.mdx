...
- Site rules apply to Chrome and, in the unreleased development version, Safari. Changes apply on the next configuration-watch cycle, normally within 2 seconds; no restart is required.
