...
This envelope is also published as a machine-readable JSON Schema at [`/schema/event.schema.json`](/schema/event.schema.json). It is the single contract all surfaces share, and the file the Rust core's types are tested against.
