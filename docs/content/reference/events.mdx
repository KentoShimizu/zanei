...
| `browser.navigate` | `macos.applescript` | URL / tab change. Chrome and Safari (unreleased); Chrome Incognito excluded | Accessibility + Automation |
...
| **Safari** | ✅ Supported in the unreleased development version | `mode: "unknown"`; private-window exclusion is not guaranteed |
